...
What would it be? We'll be writing login script but in 2 ways. More about later in this article
...
You should be familiar with those, at this point - If not, check out parts [7](https://wizarddos.github.io/blog/programming/PHP_0_to_hero/7) and [8](https://wizarddos.github.io/blog/programming/PHP_0_to_hero/8) and then come back here

Also, start a session - if you know nothing about them check out [part 5](https://wizarddos.github.io/blog/programming/PHP_0_to_hero/5) of this course
...
That's it from cybersec point of view - if you want to learn more, check out [this module from Portswigger](https://portswigger.net/web-security/sql-injection) and let's come back to writing
