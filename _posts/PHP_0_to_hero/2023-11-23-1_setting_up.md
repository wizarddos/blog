...
Last thing is - go to [http://localhost/server-test/](http://localhost/server-test/) and check. If you see `Hello World` written on it - that means your server worked
